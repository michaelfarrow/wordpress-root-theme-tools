...
function root_widgets_init() {
  ...
  // Widgets
  register_widget('Root_Vcard_Widget');
}
 ...
 */
class Root_Vcard_Widget extends WP_Widget {
  ...
  function __construct() {
    $widget_ops = array('classname' => 'widget_root_vcard', 'description' => __('Use this widget to add a vCard', 'roots'));

    $this->WP_Widget('widget_root_vcard', __('Roots: vCard', 'roots'), $widget_ops);
    $this->alt_option_name = 'widget_root_vcard';
  ...
  function widget($args, $instance) {
    $cache = wp_cache_get('widget_root_vcard', 'widget');
  ...
  <?php
    ...
    wp_cache_set('widget_root_vcard', $cache, 'widget');
  }
  ...
  function update($new_instance, $old_instance) {
    ...
    if (isset($alloptions['widget_root_vcard'])) {
      delete_option('widget_root_vcard');
    }
  ...
  function flush_widget_cache() {
    wp_cache_delete('widget_root_vcard', 'widget');
  }
